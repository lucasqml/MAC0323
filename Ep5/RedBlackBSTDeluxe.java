...
/******************************************************************************
 *  Compilation:  javac RedBlackBSTPlus.java
 *  Execution:    java RedBlackBSTPlus < input.txt
 ...
 *  
 *  % java RedBlackBSTPlus < tinyST.txt
 *  A 8
 *  C 4
 *  E 12
 *  H 5
...
public class RedBlackBSTDeluxe<Key extends Comparable<Key>, Value> {
    ...
    private class Node {
        ...
        public Node(Key key, Value val, boolean color, int size, int height, int ipl) {
            this.key = key;
            this.val = val;
            this.color = color;
            this.size = size;
    ...
    ***************************************************************************/
    ...
    /**
     * Unit tests the {@code RedBlackBSTPlus} data type.
     *
     * @param args the command-line arguments
     */
    public static void main(String[] args) { 
        RedBlackBSTDeluxe<String, Integer> st = new RedBlackBSTDeluxe<String, Integer>();
