...
/******************************************************************************
 *  Compilation:  javac BSTPlus.java
 *  Execution:    java BSTPlus
...
/**
 *  The {@code BSTPlus} class represents an ordered symbol table of generic
 *  key-value pairs.
...
public class BSTDeluxe<Key extends Comparable<Key>, Value> {
    ...
    private class Node {
        ...
        public Node(Key key, Value val, int size, int height, int ipl) {
            this.key = key;
            this.val = val;
            this.size = size;
            this.height = height;
    ...
    // return number of key-value pairs in BSTPlus rooted at x
    ...
    // Return key in BSTPlus rooted at x of given rank.
    ...
    /**
     * Returns the height of the BSTPlus (for debugging).
     *
     * @return the height of the BSTPlus (a 1-node tree has height 0)
     */
    public int height() {
        return height(root);
    }
    ...
    /**
     * Returns the keys in the BSTPlus in level order (for debugging).
     *
     * @return the keys in the BSTPlus in level order traversal
     */
  ...
  /*************************************************************************
    *  Check integrity of BSTPlus data structure.
    ***************************************************************************/
    ...
    // is the tree rooted at x a BSTPlus with all keys strictly between min and max
    ...
    /**
     * Unit tests the {@code BSTPlus} data type.
     *
