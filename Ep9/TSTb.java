...
public class TSTb<Value> {
    private int n;              // size
    private Node<Value> root;   // root of TSTb
    ...
    public String longestPrefixOf(String query, int t) {
        ...
        Suffix suffix = new Suffix(query, t);
    ...
    /**
     * Unit tests the {@code TSTb} data type.
     *
    ...
    public static void main(String[] args) {
        ...
        StdOut.println(st.longestPrefixOf("shellsort", 0));
        StdOut.println();

        StdOut.println("longestPrefixOf(\"shell\"):");
        StdOut.println(st.longestPrefixOf("shell", 0));
        StdOut.println();
